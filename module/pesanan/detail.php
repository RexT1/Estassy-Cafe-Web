...
<div id="frame-faktur">
	...
	<table class="table-list">
		...
		<?php
			...
			$queryDetail = mysqli_query($koneksi, "SELECT pesanan_detail.*, menu.nama_menu FROM pesanan_detail JOIN menu ON pesanan_detail.menu_id=menu.menu_id WHERE pesanan_detail.pesanan_id='$pesanan_id'");
	...
	<div id="frame-keterangan-pembayaran">
		<p>Silahkan Lakukan pembayaran ke OVO/Dana/Gopay<br/>
		   Nomor Account : 0813456789 (A/N Estassy).<br/>
